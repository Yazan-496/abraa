...
const EditorItem = (
  { options, read_only, name, code, value, description },
  control,
  errors,
  register,
  setValue,
      ...
      <FormGroup>
        ...
        <TextEditor
          ...
          editorClassName={classnames("", {
            "is-invalid": errors && !_.isEmpty(_.get(errors, `sub-${code}`))
          })}
          readOnly={read_only}
        />
        {/*<Controller*/}
        ...
        {errors && _.get(errors, `sub-${code}`) && (
          <FormFeedback>_.get(errors,`sub-${code}.message`)</FormFeedback>
        )}
