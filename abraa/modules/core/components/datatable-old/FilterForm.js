...
import { Input, CardBody, Button, Form, FormGroup, Label, Col, Row } from "reactstrap"
...
const FilterForm = ({ columns, onFilter }) => {
  ...
  const _renderControl = (c) => {
    ...
    if (type === "select") {
      ...
      return <Controller as={Input} control={control} name={c.selector} defaultValue="" />
    }
    return null
  }
  //************************************//
  ...
  //************************************//
  return (
    <CardAction title={trans("gen.actions.search")} actions="collapse">
