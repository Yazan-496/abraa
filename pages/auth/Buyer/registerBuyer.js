...
import { SendPhoneNumber, check_existing_email, _getCountries, _register } from "../../../redux/actions"
        ...
        _register(
          {
            ...
            signup_country_id: selectedValue,
            roles: roles,
              ...
              >
                ...
                <div className="input-group">
                  <label
                    ...
                    htmlFor="productYouLike"
                  >
                    {currentLocale === "ar" ? "منتجات تفضل مصدرها" : "Products You Like To Source"}
                  </label>
                  <Controller
                    control={control}
                    type="text"
                    ...
                    name="productYouLike"
                    id="productYouLike"
                    value={productYouLike}
                    defaultValue={productYouLike}
                    // rules={registerOptions.company}
                    render={({ field }) => <input {...field} label="Text field" />}
                  />
                </div>
...
export default withRouter(RegisterBuyer)
