            ...
            <div className="card product-panel">
              <div className="toolbar flex-bar">
                <div className="flex-bar-start">
                  <div className="flex-item first-item" id="selectall">
                    <div data-reactroot className="checkbox-solid-sm">
                      <input type="checkbox" defaultValue="None" id="new" name="check" />
                      <label htmlFor="new" />
                    </div>
                  </div>
                ...
                <div className="flex-bar-middle">
                  <div className="flex-item" id="deletecomp" style={{ display: "none" }}>
                    <button data-reactroot className="btn btn-default btn-simple delete-btn">
                      <span className="fa fa-trash" />
                      {/* react-text: 3 */} {/* /react-text */}
                      <span className="custom-span">Delete</span>
                    </button>
                  </div>
                  <div className="flex-item" id="markassoldcomp" style={{ display: "none" }}>
                    <div data-reactroot className="checkbox-solid-sm">
                      <input type="checkbox" defaultValue="None" id="sold" name="check" />
                      <label htmlFor="sold" />
                      <span className="custom-span">Mark as Inactive</span>
                    </div>
                  </div>
                  <div className="flex-item" id="markasmnotsoldcomp" style={{ display: "none" }}>
                    <div data-reactroot className="checkbox-solid-sm">
                      <input type="checkbox" defaultValue="None" id="not-sold" name="check" />
                ...
                <div className="flex-bar-end">
                  <div className="flex-item" id="searchbar">
                    <div data-reactroot className="input-group search-bar">
                      <input type="text" id="search_keyval" className="form-control" placeholder="Search.." />
              ...
              <div className="row" id="productlist">
                <div className="content-loadings" style={{ display: "none" }}>
                  <img src="https://assets.abraacdn.com/assets/images/ajax-loader.gif" alt="loading icon" />
                </div>
