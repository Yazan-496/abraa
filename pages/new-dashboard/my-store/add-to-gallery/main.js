const Main = () => {
  return (
    <div className="content" id="content">
      <link href="https://assets.abraacdn.com/assets/css/fileinput.css" rel="stylesheet" />
      <div className="center_point ">
            ...
            <div className="input-group file-caption-main">
              ...
              <div className="input-group-btn">
                <button
                  ...
                  className="btn btn-default fileinput-remove fileinput-remove-button"
                >
                  <i className="glyphicon glyphicon-trash" /> <span className="hidden-xs">Remove</span>
                </button>
                <button
                  type="button"
                  tabIndex={500}
                ...
                >
                  <i className="glyphicon glyphicon-ban-circle" /> <span className="hidden-xs">Cancel</span>
                </button>
                <a
                  href="https://www.abraa.com/ajax.php?do=upload-gallery-files"
                  tabIndex={500}
                  title="Upload selected files"
                  className="btn btn-default fileinput-upload fileinput-upload-button"
                >
                  <i className="glyphicon glyphicon-upload" /> <span className="hidden-xs">Upload</span>
                </a>
                <div tabIndex={500} className="btn btn-primary btn-file">
                  <i className="glyphicon glyphicon-folder-open" />
                  &nbsp; <span className="hidden-xs">Browse …</span>
                  <input id="input-id" type="file" multiple className />
                </div>
              </div>
            </div>
          </div>
