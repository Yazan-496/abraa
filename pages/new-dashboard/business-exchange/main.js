  ...
  return (
    <div className="content" id="content">
      ...
      <div className="row">
        ...
        <div className="col-xs-6" style={{ textAlign: "right", padding: "25px 10px" }}></div>
      </div>
      <fieldset style={{ border: "1px solid #eee", padding: 10 }}>
        <legend style={{ borderBottom: "none", width: "unset", fontSize: "12pt" }}>
        ...
        <div className="filter-cont" style={{ display: "block" }}>
                ...
                >
                  <span className="selection">
                    <span
                      ...
                      aria-disabled="false"
                    >
                      <ul className="select2-selection__rendered" id="select2-ctry_filter-container" />
          ...
          <div className="row">
            <div className="col-xs-12">
              <button className="btn btn-success btn-outline btn-xs" id="search-btn">
                Search
      ...
      <div className="info-container">
        ...
        <div className="col-smd-3">
          <span className="label label-default">0 </span> Remainig Leads Per Month
          <hr />
        </div>
      </div>
      <hr />
