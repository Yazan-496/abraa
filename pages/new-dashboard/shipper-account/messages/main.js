          ...
          <div className="tab-content card ml-141">
            ...
            <div id="security" className="tab-pane card-content fade in">
              <div className="toolbar flex-bar">
                ...
                <div className="flex-bar-middle">
                  <div className="flex-item" id="resdeleteComp" style={{ display: "none" }}>
                  ...
                  <div className="flex-item" id="resmarkreadComp" style={{ display: "none" }}>
                    <div className="checkbox-solid-sm">
                  ...
                  <div className="flex-item" id="resmarkunreadComp" style={{ display: "none" }}>
                    <div className="checkbox-solid-sm">
            ...
            <div id="inbox" className="tab-pane card-content fade in active">
              <div className="toolbar flex-bar">
                ...
                <div className="flex-bar-middle">
                  <div className="flex-item" id="inbdeleteComp" style={{ display: "none" }}>
                    <button className="btn btn-default btn-simple delete-btn">
                      <span className="fa fa-trash" />
                  ...
                  <div className="flex-item" id="inbmarkreadComp" style={{ display: "none" }}>
                    <button className="btn btn-default btn-simple delete-btn">
                  ...
                  <div className="flex-item" id="inbmarkunreadComp" style={{ display: "none" }}>
                    <button className="btn btn-default btn-simple delete-btn">
                      <span className="far fa-envelope margin-right-5" />
