            ...
            <div className="card buyer-card">
              <div className="toolbar flex-bar" id="flex-bar">
                ...
                <div className="flex-bar-middle">
                  <div className="flex-item" id="deletecomp" style={{ opacity: "0.5" }}>
                  ...
                  <div className="flex-item" id="markassoldcomp" style={{ opacity: "0.5" }}>
                    <button className="btn btn-default btn-simple delete-btn">
                  ...
                  <div className="flex-item" id="markasmnotsoldcomp" style={{ opacity: "0.5" }}>
                    <button className="btn btn-default btn-simple delete-btn">
                      <span className="far fa-envelope margin-right-5" />
              ...
              <div className="row " id="requestrows">
                <div className="col-md-12 product-list" id="productlist">
                  <table id="data-table" className="table data-table table-hover">
                    <thead>
                      <tr>
                  ...
                  <div className="custom-modal card-body p-x-0" id="order-details">
                    ...
                    <div className="table-container modal-padding">
                      <table id="data-table" className="table data-table table-hover item-details">
                        <thead>
                          <tr>
                            <th>
                              <a href="">Item name</a>
                    ...
                    <div className="d-flex justify-content-center mt-15">
                      <a href="" data-id className="btn btn-fill btn-danger ml-7 mr-7">
                        Cancel Order
                      </a>
                      <a href="" className="btn btn-info ml-7 mr-7">
                        Close
                      </a>
                    </div>
                  </div>
