                        ...
                        <div className="modal-content">
                          ...
                          <div className="modal-body">
                            <div className="reslutiondata_main">
                              <div className="left">Item(From your orders)*</div>
                              <div className=" rightbb">
                                <select className="form-control select_ox" id="meassageitemtrigger">
                                  <option />
                                </select>
                            ...
                            <div className="reslutiondata_main">
                              ...
                              <div className="rightbbs">
                                <select id="resProbsval" className="form-control select_ox ">
                          ...
                          <div className="modal_footer">
                            <a href="#" id="payemntadd" className="btn button1" data-dismiss="modal">
                              Send
                            </a>
                            <a href="#" id="payemntcancel" data-dismiss="modal" className="btn button2">
                              Cancel
                            </a>
                          </div>
                        </div>
